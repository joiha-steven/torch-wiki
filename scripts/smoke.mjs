...
const PAGES = ['/', '/brands', '/compare', '/contribute', '/top', '/log', '/data-log', '/guide', '/privacy']
...
async function checkOneDetail() {
  try {
    ...
    const reserved = new Set(['brands', 'compare', 'contribute', 'top', 'log', 'data-log', 'updates', 'guide', 'privacy',
