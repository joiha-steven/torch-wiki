          ...
          {tab === 'mfa' && (
            <>
              ...
              <input type="text" inputMode="numeric" maxLength={6} value={totpCode}
                ...
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-300 text-center tracking-widest text-lg font-mono"
          ...
          {tab === 'recovery' && (
            <>
              ...
              <input type="text" value={recoveryCode} onChange={e => setRecoveryCode(e.target.value.toUpperCase())}
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-300 font-mono"
