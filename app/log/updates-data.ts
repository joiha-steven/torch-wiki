...
export const UPDATES: UpdateEntry[] = [
  {
    ...
    "items": [
      ...
      "Behind the scenes: the brand data-import scripts are now kept in our private workspace rather than the public code repo - they're a maintenance tool, not part of the site",
