...
export const UPDATES: UpdateEntry[] = [
  {
    ...
    "items": [
      ...
      "Flashlight pages now show a \"Beam reach\" bar - a quick visual of how far a light throws compared to the farthest thrower in the catalog, so you can gauge its reach at a glance",
      "The side-by-side Compare now highlights the best value in more rows: brightest output, longest throw and highest beam intensity, plus the lightest and the cheapest - the winning cell in each row stands out in amber",
      "Small visual polish across the site: tighter heading spacing and a softer amber badge on active filter groups",
