...
export const UPDATES: UpdateEntry[] = [
  {
    ...
    "items": [
      ...
      "Refreshed the top navigation bar: darker, flatter and more modern (dropped the glossy 3D look), a touch slimmer, sitting slightly wider than the page content with comfortable margins on mobile. The search box is more compact too. Browse also remembers when you've hit \"Show more\" in a filter group (e.g. the full Brand list)",
