...
export const UPDATES: UpdateEntry[] = [
  {
    ...
    "items": [
      "Added Convoy - 22 lights from the S-series of the popular, highly modular Chinese brand: the compact S2+ and the 21700 S21 family (S21A/B/D/E/F/G), plus the S3/S6/S8/S9/S10/S11/S12/S15/S16 and the big S26A. Premium-material editions are listed as their own entries - the S2+ in brass, copper and titanium, and the copper-head S21G - while plain colour options are merged into one entry per host. Specs are in; product photos are coming soon",
