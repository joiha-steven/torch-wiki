...
export const UPDATES: UpdateEntry[] = [
  {
    ...
    "items": [
      ...
      "The top navigation bar is a little larger now and sits slightly wider than the page, so its rounded capsule reads better. Browse also remembers when you've hit \"Show more\" in a filter group (e.g. the full Brand list)",
