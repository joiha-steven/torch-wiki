  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-ink-3 text-sm">Please sign in first.</p>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="bg-panel rounded-2xl shadow-lg border border-line w-full max-w-sm p-6">
        ...
        <h1 className="text-lg font-bold text-ink mb-1">Change Password</h1>
        <p className="text-xs text-ink-3 mb-5">{user.email}</p>
        ...
        {done ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label className="block text-xs font-medium text-ink-2 mb-1">Current password</label>
              <input
                type="password"
                value={current}
            ...
            <div>
              <label className="block text-xs font-medium text-ink-2 mb-1">Confirm new password</label>
              <input
                type="password"
                value={confirm}
            ...
            <Link href="/" className="block text-center text-xs text-ink-3 hover:text-ink-2 pt-1">
              Cancel
            </Link>
          </form>
        )}
